...
- Claude AI — file summarization, architecture analysis, codebase chat
- JWT authentication
...
- **Structured AI output** — Architecture analysis prompts Claude to return strict JSON for reliable parsing and rendering
...
- Designed cost-efficient multi-call AI architecture using Claude Haiku for file summarization and context-aware codebase chat
